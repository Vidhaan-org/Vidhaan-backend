...
def notify_case_updates(sender, instance, created,**kwargs):
    ...
    if instance.notify_type=='Doc Deadline': 
        ...
        send_mail(
            'Case Update',
            f'Last date to submit your documents is {instance.case.case_document.recieving_date}',
            'vidhaan.inbox@gmail.com',
            ['suryansh.1191@gmail.com', 'rahulkesharwani353@gmail.com', 'sonaljain067@gmail.com', 'dewansh.dt@gmail.com', 'emailanubhavagrawal@gmail.com']
        ) 
        ...
        message = client.messages \
        .create(
            body=f'Last date to submit your documents is {instance.case.case_document.recieving_date}',
            from_='+19786629400',
            to='+919179322789'
            ) 
        print('Doc Deadline')
    ...
    if instance.notify_type=='Next Hearing': 
        ...
        send_mail(
            'Case Update',
            f'The next hearing date is on {instance.case.history.hearing_date}. Visit the website to get more info about it!',
            'vidhaan.inbox@gmail.com',
            ['suryansh.1191@gmail.com', 'rahulkesharwani353@gmail.com', 'sonaljain067@gmail.com', 'dewansh.dt@gmail.com', 'emailanubhavagrawal@gmail.com']
        ) 
        ...
        message = client.messages \
        .create(
            body=f'The next hearing date is on {instance.case.history.hearing_date}. Visit the website to get more info about it!',
            from_='+19786629400',
            to='+919179322789'
            )
    ...
    if instance.notify_type=='Hearing in 2 days': 
            ...
            send_mail(
                'Case Update',
                f'The next hearing date is on 2 days i.e {instance.case.history.hearing_date} of case {instance.case}. Visit the website to get more info about it!',
                'vidhaan.inbox@gmail.com',
                ['suryansh.1191@gmail.com', 'rahulkesharwani353@gmail.com', 'sonaljain067@gmail.com', 'dewansh.dt@gmail.com', 'emailanubhavagrawal@gmail.com']
            ) 
            ...
            message = client.messages \
            .create(
                body=f'The next hearing date is on 2 days i.e {instance.case.history.hearing_date} of case {instance.case}. Visit the website to get more info about it!',
                from_='+19786629400',
                to='+919179322789'
                )
